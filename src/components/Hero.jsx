    ...
    <div className="w-full h-full p-2 mt-10">
      ...
      <div className="bg-gray-200  mt-16">
        <div class="mt-3 flex -space-x-2 relative ">
          <img
            class="inline-block w-7/12 absolute rounded-xl hover:scale-105 transition duration-500 ease-in-out"
            src={img1}
            alt=""
          />
          <img
            class="inline-block w-7/12 rounded-xl absolute right-20 hover:scale-105 transition duration-500 ease-in-out"
            src={img2}
            alt=""
          />
        
            <div className=" bg-white p-4 absolute right-10 rounded-xl flex flex-col  hover:scale-105 transition duration-500 ease-in-out w-6/12">
              <img class="rounded-xl" src={img3} alt="" />
              <div className="flex justify-between p-2 mt-4">
                <div className="text-gray-400  font-medium text-xl">
                  Speckled bowl set
                  <div className="font-normal text-base">Set of two</div>
                </div>
