        ...
        <div className="flex gap-8 max-md:flex-col">
          ...
          <div className="flex flex-col gap-4 p-4 ">
            ...
            <div className="text-gray-600 font-semibold"
              ...
              Inventore accusamus officia eligendi eveniet veritatis sequi id
              nemo repellat, quia libero tempora, praesentium ipsa! Magni in
              quam nesciunt, omnis dolore voluptate.
            </div>
            <div className="text-xl font-bold text-blue-600 flex">
