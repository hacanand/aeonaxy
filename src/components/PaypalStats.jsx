...
function PaypalStats() {
  return (
    <div className='w-full h-full'>
      <div className="mt-48 flex justify-evenly flex-wrap">
        <div className="flex flex-col">
          <div className=" text-9xl max-md:text-5xl font-bold text-blue-900 px-6">
            401%
          </div>
          <div className="font-medium text-balance p-4 w-96 text-3xl max-md:text-xl">
